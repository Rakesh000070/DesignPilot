...
const Portfolio: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden">
      {/* Header Section */}
      <section className="pt-20 pb-20 bg-white border-b border-neutral-100">
            ...
            <AnimatePresence mode="popLayout" initial={false}>
              {filteredProjects.map((project) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="relative rounded-3xl overflow-hidden mb-8 aspect-[4/3] shadow-xl group-hover:shadow-2xl transition-shadow duration-500 text-[0]">
                    <img 
                      src={project.image} 
                      alt={project.title} 
                      ...
                      decoding="async"
                    />
                    <div className="absolute inset-0 bg-neutral-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-8 text-center">
                      <div className="text-white">
                        <Tag size={24} className="mx-auto mb-4 text-primary-400" />
                        <h4 className="font-display font-bold text-xl mb-2">The Challenge</h4>
                  ...
                  <div className="px-2">
                    <div className="flex items-center justify-between mb-3">
                      <span className="px-3 py-1 bg-primary-50 text-primary-600 text-[10px] font-bold uppercase tracking-widest rounded-lg">
                        {project.category}
                      </span>
                    ...
                    <h3 className="text-2xl font-display font-bold text-neutral-900 mb-4 group-hover:text-primary-600 transition-colors">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                      {project.features.map((feature, i) => (
                        <span key={i} className="text-[10px] font-semibold text-neutral-500 bg-neutral-100 px-2 py-1 rounded">
                          {feature}
                        </span>
                      ))}
                    </div>

                    <button className="flex items-center text-primary-600 font-bold text-sm group/btn hover:text-primary-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-8 italic text-primary-400">Our Quality Standard</h2>
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <div className="w-6 h-6 bg-primary-600 rounded-full flex items-center justify-center shrink-0 mt-1 border-4 border-neutral-900 ring-1 ring-primary-500">
                    </div>
                    <div className="ml-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white/5 p-10 rounded-[3rem] border border-white/10 backdrop-blur-sm text-center"
            >
              <div className="inline-flex items-center justify-center w-20 h-20 bg-primary-600 rounded-3xl mb-8 shadow-2xl shadow-primary-500/20">
                <ExternalLink size={32} />
              </div>
              <h3 className="text-2xl font-display font-bold mb-4">Want a Site Like These?</h3>
              ...
              <NavLink 
                to="/contact" 
                className="inline-block px-10 py-4 bg-primary-600 text-white rounded-full font-bold hover:bg-primary-700 transition-all shadow-xl shadow-primary-500/20"
              >
                Start Your Project
              </NavLink>
            </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-display font-bold text-neutral-900 mb-8">Not Seeing Your Industry?</h2>
          ...
          <NavLink 
            to="/contact" 
            className="inline-flex items-center px-8 py-3 border-2 border-primary-600 text-primary-600 rounded-full font-bold hover:bg-primary-600 hover:text-white transition-all group"
          >
